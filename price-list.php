		...
		<div class="row h-100 justify-content-center align-items-center">
			<div class="col-12 ">
				<ul class="nav justify-content-center">
					<li class="nav-item active lead price_nav" id="w">
						<a class="nav-link active lead_color" id="w1" href="#wash-and-iron" data-toggle="tooltip" data-placement="bottom" title="Click to see Cost of  wash and Iron">Wash-and-Iron</a>
					</li>
					<li class="nav-item price_nav" id="i">
						<a class="nav-link text-dark" href="#ironing" id="i1" data-toggle="tooltip" data-placement="bottom" title="Click to see cost of only Ironing">Ironing</a>
					</li>
					<li class="nav-item price_nav" id="d">
						<a class="nav-link text-dark" id="d1" href="#dry-cleaning" data-toggle="tooltip" data-placement="bottom" title="Click to see cost of Dry-cleaning">Dry-cleaning</a>
					</li>
		...
		<section class="container h-100 services">
				...
				<div class="col-lg-12 col-md-12 col-lg-12">
					<div class="row">
						<div class="w-50 mx-auto ">
							<h2 class="text-center fnt-wt-sm men_price">Men</h2>
							<div class="row">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-lg-12">
					<div class="row">
						<div class="w-50 mx-auto">
							<h2 class="text-center fnt-wt-sm men_price">Women</h2>
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 ">
									<table class=" table table-bordered table-hover table-condensed">
										<tbody>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-lg-12 ">
					<div class="row">
						<div class="w-50 mx-auto">
							<h2 class="text-center fnt-wt-sm men_price">HouseHold</h2>
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 ">
									<table class=" table table-bordered table-hover table-condensed">
										<tbody>
	...
	<script>
		$(document).ready(function() {
			...
			$("[href='#wash-and-iron']").click(function() {
				...
				$("#w1").addClass("active lead_color");
				$("#i1").removeClass("active lead_color");
				$("#d1").removeClass("active lead_color");

				$("#w1").removeClass("text-dark");
				$("#i1").addClass("text-dark");
				$("#d1").addClass("text-dark");
			});
			$("[href='#ironing']").click(function() {
				$("#wash-and-iron, #dry-cleaning").hide();
				$("#ironing").show();
				$("#i").addClass("active lead");
				$("#w").removeClass("active active lead");
				$("#d").removeClass("active active lead");

				$("#i1").addClass("active lead_color");
				$("#w1").removeClass("active lead_color");
				$("#d1").removeClass("active lead_color");

				$("#i1").removeClass("text-dark");
				$("#w1").addClass("text-dark");
				$("#d1").addClass("text-dark");
			});
			$("[href='#dry-cleaning']").click(function() {
				...
				$("#d1").addClass("active lead_color");
				$("#i1").removeClass("active lead_color");
				$("#w1").removeClass("active lead_color");

				$("#d1").removeClass("text-dark");
				$("#i1").addClass("text-dark");
				$("#w1").addClass("text-dark");
			});
		});
