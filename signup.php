                    ...
                    <div class="login-wrapper my-auto">
                        ...
                        <form id="signupform" action="">
                            <div class="form-group">
                                ...
                                <input type="text" name="firstname" id="firstname" class="form-control input-sm" placeholder="akanksha">
                            </div>
                            <div class="form-group">
                                <label for="lastname">Last Name</label>
                                <input type="text" name="lastname" id="lastname" class="form-control input-sm" placeholder="udakhe">
                            </div>
                            <div class="form-group">
                                <label for="phone">Phone No.</label>
                                <input type="text" name="phone" id="phone" class="form-control input-sm" placeholder="9876543210">
                            </div>
                            <div class="form-group">
